...
// I'm adding a few comments C-style with the double slashes. Take them out when you've thought about them.

// Having scanned through all of this, I like overall how it looks. You have one or two other data sets to
// talk about as well, don't you? Also, once you have a regression and a classification example, you might be able
// to do a compare-and-contrast about how well they work (and maybe even compare that to what you've read about how well
// classification and regression typically work in this context).
...
// you could have 2 paragraphs here, one about trees, and a second about making forests out of trees.
...
// it would help to know the difference between "its" and "it's"!
...
// I like this (above) -- makes the whole thing alive!
...
// you can have or point to an introduction about what the wine data set contains
