...
\begin{itemize}
  ...
  $\\$
  \item For each tree, choose variables from the feature space, and get a bootsrap. 
  $\\$
...
>>>>>>> 1c1ff82aa8a59d5e0270392244c03bcb53f1e473
...
The data is formatted so that the quality is the last column of the data set. We will propperly read and process the data so that we can run it through our random forest algorithm.
...
Now, we try again with a higher number of variables. We find that with M = 3, the result hanges.
