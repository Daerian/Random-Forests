...
\begin{theo}
  \begin{enumerate}
    ...
    \item For each seed, loop through all feasible values of hyperparameters
    \item For each value of hyperparameters, record the value according to 2 cases:
    \begin{enumerate}
